		...
		<div class="row">
			<div class="col-md-3">
	            ...
	            <div class="form-group">
	                <label for="description">IPFS Hash</label>
	                <input class="form-control" placeholder="Enter the Hash" type="text" v-model="userName">
	            </div>

	            <div class="form-group">
	                <label for="description">Status</label>
	                <input class="form-control" placeholder="Enter current status" type="text" v-model="userStatus">
	            </div>
                ...
                <div v-show="successMessage" class="alert alert-success mt-3" role="alert">
                    <strong>This account has been registerd!</strong>
                    <br>
